...
export interface AEOFAQItem {
  ...
  question: string;
  /** Conversational answer with internal links to / and /about. */
  answer: string;
...
export const AEO_FAQ_ITEMS: AEOFAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "You can support Flaget Hoop House 502 through our GoFundMe campaign by visiting <a href=\"https://gofund.me/8072dffdc\" target=\"_blank\" rel=\"noopener noreferrer\" className=\"text-brand-orange hover:underline\">gofund.me/8072dffdc</a>. Every dollar goes directly back into the facility — covering HVAC repairs, court resurfacing, and ongoing costs that keep this community space open for young people in Louisville. Even small contributions make a real difference. <a href=\"/about\" className=\"text-brand-orange hover:underline\">Read about our mission</a> to learn why this project matters.",
    keywords: ["Hoop House 502 donate", "Flaget Hoop House GoFundMe", "support Louisville basketball", "donate to youth basketball Louisville"],
  },
  {
  ...
  },
  {
    ...
    answer:
      "Flaget Hoop House 502 is open <strong>24 hours a day, 7 days a week, 365 days a year</strong>. There's no check-in time or closing time — you book your own window and use your access code whenever you need. Whether you want an early-morning shootaround at 5 AM or a late-night session after 11 PM, the court is yours.",
    keywords: ["Hoop House 502 hours", "24/7 basketball court Louisville", "Hoophouse 502 open late", "when is Hoop House 502 open"],
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Flaget Hoop House 502 was created as a <strong>safe space for young people</strong> in West Louisville. The facility features security cameras monitored remotely, keyless entry via personal access codes (so only booked guests can enter), and a mission centered on keeping youth engaged through sports, tutoring, and mentorship. Parents feel comfortable letting their kids use the facility, and our programming — including free tutoring and mental health support — shows we take that trust seriously. <a href=\"/about\" className=\"text-brand-orange hover:underline\">Read about our community mission</a>.",
    keywords: ["Hoop House 502 safe for kids", "family friendly basketball Louisville", "youth safe basketball Louisville KY", "is Hoop House 502 safe"],
  },
];
...
export function buildFAQJSONLDFragment(): string {
  const mainEntity = AEO_FAQ_ITEMS.map((item) => ({
    ...
    acceptedAnswer: {
      ...
      text: item.answer.replace(/<[^>]*>/g, ""), // Strip HTML tags for the raw answer text
    },
  }));
